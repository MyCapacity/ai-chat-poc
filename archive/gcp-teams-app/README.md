## NOTE
This template has been heavily modified, while some of the documentations might still be true, we are not using any of the AI agent or assistant libraries due to lack of support for Azure AI Service.
